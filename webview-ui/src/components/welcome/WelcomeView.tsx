	...
	return (
		<Tab>
			<TabContent className="flex flex-col gap-5">
				...
				<div className="mb-4">
					<h4 className="mt-3 mb-2 text-center">{t("welcome:startMakehub")}</h4>
								...
								const providers = [
									{
										slug: "makehub",
										name: "MakeHub",
										description: t("welcome:routers.makehub.description"),
										incentive: t("welcome:routers.makehub.incentive"),
										authUrl: "https://makehub.ai/api-keys",
									},
								]
